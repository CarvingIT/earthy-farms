    ...
    <div class="py-10 bg-[#f5f5f7] min-h-screen">
        <div class="max-w-xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div>
                ...
                <h1 class="text-2xl font-bold tracking-tight text-neutral-900 mt-3">Add New Farmer</h1>
                <p class="text-xs text-neutral-500 mt-0.5">Register a new farmer with name, address, and coordinates.</p>
            </div>
