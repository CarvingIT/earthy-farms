        ...
        <div class="flex justify-between h-16">
            <div class="flex items-center w-full justify-between sm:justify-start">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <button id="pwa-header-install-btn" class="p-2 text-neutral-400 hover:text-neutral-600 hover:bg-neutral-50 rounded-full focus:outline-none transition-colors duration-200" style="display: none;" title="Install ECSPL Farms">
